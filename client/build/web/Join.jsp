        ...
        <div class="row">
            <div class="col-sm-12 bg-light ">
                <form name="gInfo" class="d-flex flex-column needs-validation"
                    ...
                    <h2 class="mt-4" style="margin-left:40%;  font-weight: bold;">Join Our Hotel Family</h2>
                    <br>
                    <div class="form-row">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text"
                                   class="form-control" id="inputCity" placeholder="City" name="city" required>
                            <div class="valid-feedback">Right on!</div>
                            <div class="invalid-feedback">your city Please</div>
                        </div>
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-6">
                            <label for="inputZip"style="font-weight: bold;">Postal Code</label> 
                            <input type="text"
                                   class="form-control" id="inputZip" placeholder="Postal Code"
                                   name="postalCode" required>
                            <div class="valid-feedback">yeah!</div>
                            <div class="invalid-feedback">Postel Code Please.</div>
                        </div>
