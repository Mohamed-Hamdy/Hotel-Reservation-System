...
<html>
    <head>
        ...
        ></script>
        <!-- Css Styles -->
        <link rel="stylesheet" href="Sonacss/bootstrap.min.css" type="text/css">
        <link rel="stylesheet" href="Sonacss/font-awesome.min.css" type="text/css">
        <link rel="stylesheet" href="Sonacss/elegant-icons.css" type="text/css">
        <link rel="stylesheet" href="Sonacss/flaticon.css" type="text/css">
        <link rel="stylesheet" href="Sonacss/owl.carousel.min.css" type="text/css">
        <link rel="stylesheet" href="Sonacss/nice-select.css" type="text/css">
        <link rel="stylesheet" href="Sonacss/jquery-ui.min.css" type="text/css">
        <link rel="stylesheet" href="Sonacss/magnific-popup.css" type="text/css">
        <link rel="stylesheet" href="Sonacss/slicknav.min.css" type="text/css">
        <link rel="stylesheet" href="Sonacss/style.css" type="text/css">
        ...
        <body>
            <%
//                String img1_url = (String) session.getAttribute("images_gallery_image1");
//                String img2_url = (String) session.getAttribute("images_gallery_image2");
//                String img3_url = (String) session.getAttribute("images_gallery_image3");
//                String img4_url = (String) session.getAttribute("images_gallery_image4");
                HttpSession usersession = request.getSession();
                int hotelid = Integer.parseInt(request.getParameter("hid"));
                //int hotelid = Integer.parseInt(hotelnumber);
                String hotelName = request.getParameter("hotelname");
                String img1_url = request.getParameter("gallary_1");
                String img2_url = request.getParameter("gallary_2");
                String img3_url = request.getParameter("gallary_3");
                String img4_url = request.getParameter("gallary_4");
                String map = request.getParameter("hotelmap");
                String hotelimage = request.getParameter("hotelimage");
                //out.println(hotelName + "  " + hotelid);
                ...
                try {
                    ...
                    String sql = "select room_id , hotel_hotelid from room where hotel_hotelid = '" + hotelid + "';";
...
//                    out.println("</form>");
            ...
            <script src="Sonajs/jquery-3.3.1.min.js"></script>
            <script src="Sonajs/bootstrap.min.js"></script>
            <script src="Sonajs/jquery.magnific-popup.min.js"></script>
            <script src="Sonajs/jquery.nice-select.min.js"></script>
            <script src="Sonajs/jquery-ui.min.js"></script>
            <script src="Sonajs/jquery.slicknav.js"></script>
            <script src="Sonajs/owl.carousel.min.js"></script>
            <script src="Sonajs/main.js"></script>
        </body>             
    </html>
