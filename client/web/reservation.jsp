<%-- 
    ...
    Created on : Jan 11, 2021, 10:41:41 PM
    Author     : AA
--%>
            ...
            <div class="row  ">
                <div class="col-lg-8  card bg-light order-lg-first order-last">
                    <form name="gInfo" class="d-flex flex-column needs-validation"
                          style="height: 100%;" action="reservation" method="POST"
                          novalidate>
                        <%
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="number"
                                       ...
                                       placeholder="Mobile or home" value="<%=log_phone%>" min="0" required>
                        ...
                        <div class="form-row ">
                            <div class="form-group col-md-6">
                                <label for="inputCCNumber">Credit Card</label> <input
                                    ...
                                    name="ccNumber" placeholder="Secured Checkout" min="0" required>
                                <div class="valid-feedback">Looks good!</div>
                            ...
                            <div class="form-group col-md-3">
                                <label for="inputExp">Expiration</label> <input type="number"
                                                                                ...
                                                                                min="0" placeholder="MM/YY" required>
                                <div class="valid-feedback">Looks good!</div>
                                <div class="invalid-feedback">Please provide a valid
                                    expiration date.</div>
                            </div>
                        ...
                        <div class="my-auto w-100 ">
                            <input name="user_id" type="hidden"
                                   value="<%=user_id%>">
                            <input name="hotelid" type="hidden"
                                   value="<%=hotelid%>"> 
                            ...
                            <input name="checkOutForRoom" type="hidden"
                                   value="<%=checkOutForRoom%>"> 

                            <input name="nights"
                                   type="hidden" value="<%=totalDays%>"> 
                            <input name="ppn"
                                   type="hidden" value="<%=price%>">
                            <input name="tax"
                                   type="hidden" value="<%=tax%>"> 
                            <input name="total"
                                   type="hidden" value="<%=total%>">
                            <button type="hidden" class="btn btn-primary btn-block mb-2">Complete
                                Reservation</button>
                        </div>
