            ...
            <div class="panel-body">
                <div class="container-fluid">
                    <ul class="nav nav-pills">
                        ...
                        <li class="active"><a href="searchinformation.jsp">Search Information</a></li>
                            ...
                            <table id="table" class="table table-bordered">
                                ...
                                <tbody>
                                    <%  
                                        ...
                                        PreparedStatement ps = con.prepareStatement("select * from user where first_name like '%"+first_name + "%'");
